$(document).ready(function() {
    ...
    var characterOne = {
        "name": "Mega Man",
        "start health": 100,
        "image": "./assets/images/mmname.png",
        "stats": {
            "base health": 100,
            "base attack": 30,
            "base accuracy": 55
    ...
    var characterTwo = {
        "name": "Zero",
        "start health": 200,
        "image": "./assets/images/zeroname.png",
        "stats": {
            "base health": 200,
            "base attack": 15,
            "base accuracy": 67
    ...
    var enemyOne = {
        ...
        "start health": 100,
        "image": "./assets/images/cutmanname.png",
        "stats": {
            "base health": 100,
            "base attack": 10,
            "base accuracy": 40
    ...
    var enemyTwo = {
        ...
        // "character defeated": false,
        "start health": 100,
        "image": "./assets/images/bassname.png",
        "stats": {
            "base health": 100,
            "base attack": 20,
            "base accuracy": 55
    ...
    var enemyThree = {
        ...
        // "character defeated": false,
        "start health": 100,
        "image": "./assets/images/sigmaname.png",
        "stats": {
            "base health": 100,
            "base attack": 30,
            "base accuracy": 75
    ...
    function characterSelect() {
        ...
        $("#characterTwo").on("click", function() {
            $("#characterTwo").attr("class", "hightlightChar col-lg-3 col-lg-6");
